...
## Environments
- **Development**: `falafel-shop-inc-dev` namespace
- **Pre-production**: `falafel-shop-inc-preprod` namespace  
- **Production**: `falafel-shop-inc-prod` namespace
